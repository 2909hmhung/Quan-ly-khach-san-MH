...
<div class="row content-container">
    <button id="submit" class="btn btn-primary mb-3" data-toggle="modal" data-target="#exampleModal" data-title="Thêm thông tin tài khoản" data-type="insert"><i class="fa fa-plus"></i> Thêm tài khoản</button>
    <table id="datatable" style="width:100%" class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        <td>
                            <a href="#" class="btn btn-sm btn-success mb-1" title="Sửa" data-toggle="modal" data-target="#exampleModal" data-taikhoan="<?= $row['taikhoan'] ?>" data-loaitaikhoan="<?= $row['loaitaikhoan'] ?>" data-ghichu="<?= $row['ghichu'] ?>" data-title="Cập nhật thông tin tài khoản" data-type="update">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="password" name="matkhau" id="matkhau" class="form-control" maxlength="20">
                    </div>
                    <div class="form-group">
