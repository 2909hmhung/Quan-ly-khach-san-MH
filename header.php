    ...
    <div class="col-xl-9 d-flex align-items-center">
      ...
      <nav class="menu-doc">
        <ul id="menuHeader">
          ...
          <li><a href="./ql-may-tinh.php" data="ql-may-tinh">QL phòng</a></li>
          ...
          <li><a href="./thong-ke-hoa-don.php">TK hóa đơn</a></li>
          <!--<li><a href="./thong-ke-doanh-thu.php">TK doanh thu</a></li>-->
          <li><a href="./thong-ke-khach-hang.php">TK khách hàng</a></li>
